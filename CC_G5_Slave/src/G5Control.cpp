...
void G5Control::handleButtonEvent(AceButton *button, uint8_t eventType, uint8_t buttonState)
{
    ...
    _dataChanged = event;  // Don't send event on a 0 event.
}
...
G5Control::ButtonEventType G5Control::convertButtonEvent(uint8_t aceEventType)
{
    ...
    case AceButton::kEventPressed:
        ...
        return BUTTON_IDLE;   // Turns out we never care about the pressed. Not even sure what's different between click and press.
